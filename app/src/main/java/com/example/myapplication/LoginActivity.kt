...
class LoginActivity : AppCompatActivity() {
    ...
    private fun Login() {
        Column(
            ...
            Row(
                ...
                Button(onClick = { /*TODO*/ },
                    Modifier
                        ...
                        .weight(0.5f)
                        .height(55.dp),
                    border = BorderStroke(1.dp, color = Color(android.graphics.Color.parseColor("#4d4d4d")))
                    ...
                    Column(
                        ...
                        Modifier.width(25.dp).clickable {  })
            ...
            Text(
                text = "Are you new user ? Register",fontSize =16.sp,fontWeight= FontWeight.SemiBold,
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top=8.dp),
