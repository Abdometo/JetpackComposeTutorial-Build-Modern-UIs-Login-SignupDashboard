            ...
            ConstraintLayout(
                ...
                Row(
                        ...
                        horizontalAlignment = Alignment.Start)
                    {
                        ...
                        Text(text = "David Fredman", color = Color.White, fontSize = 22.sp, fontWeight = FontWeight.Bold,modifier=Modifier.padding(top=14.dp))
                ...
                Row(
                    ...
                    Column(modifier= Modifier
                        ...
                        Text(text = "Video Call", fontSize = 14.sp, fontWeight = FontWeight.Bold,fontStyle = FontStyle.Italic,color =Color(android.graphics.Color.parseColor("#c77710")))
                    }
                    Column(modifier= Modifier
                        ...
                        Text(text = "Notification", fontSize = 14.sp, fontWeight = FontWeight.Bold,fontStyle = FontStyle.Italic,color =Color(android.graphics.Color.parseColor("#c77710")))
                    }
                    Column(modifier= Modifier
                        ...
                        Text(text = "Voice Call", fontSize = 14.sp, fontWeight = FontWeight.Bold,fontStyle = FontStyle.Italic,color =Color(android.graphics.Color.parseColor("#c77710")))
                    }
                }
            }
            ...
            Row(verticalAlignment = Alignment.CenterVertically,
                ...
                Column(
                    ...
                    Text(
                        ...
                        color = Color(android.graphics.Color.parseColor("#f9c177"))
                    )
